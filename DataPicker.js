...
var day=30,month=1,year=2020,garag;
var day1=1,month1=1,year1=2009,garag1;
document.getElementById("today").innerHTML = year +" onii "+month+" sar";
document.getElementById("today1").innerHTML = year1 +" onii "+month1+" sar";
